...
CREATE TABLE Acessar (
    ...
    CONSTRAINT PK_Acessar PRIMARY KEY (CPF, SecaoId),
    CONSTRAINT FK_AcessarFuncionario FOREIGN KEY (CPF)
        REFERENCES Funcionario (CPF),
    CONSTRAINT FK_AcessarSecao FOREIGN KEY (SecaoId)
        REFERENCES Secao (Id),
    CONSTRAINT FK_AcessarArmazem FOREIGN KEY (ArmazemId)
...
INSERT INTO Acessar VALUES ('94161558023', 1, 1);
INSERT INTO Acessar VALUES ('94161558023', 2, 2);
INSERT INTO Acessar VALUES ('94161558023', 3, 1);
INSERT INTO Acessar VALUES ('94161558023', 4, 1);
INSERT INTO Acessar VALUES ('94161558023', 5, 2);
INSERT INTO Acessar VALUES ('08953368049', 2, 2);
INSERT INTO Acessar VALUES ('06605717066', 1, 3);
INSERT INTO Acessar VALUES ('06605717066', 2, 3);
INSERT INTO Acessar VALUES ('82156117020', 1, 1);
INSERT INTO Acessar VALUES ('82156117020', 2, 1);
INSERT INTO Acessar VALUES ('82156117020', 3, 1);
INSERT INTO Acessar VALUES ('77391195049', 2, 2);
...
INSERT INTO Pedido VALUES ('02329445040', TO_TIMESTAMP('2022-07-02 16:20:23', 'YYYY-MM-DD HH24:MI:SS'));
INSERT INTO Pedido VALUES ('01665061090', TO_TIMESTAMP('2022-09-28 15:14:23', 'YYYY-MM-DD HH24:MI:SS'));
...
INSERT INTO Pedido VALUES ('20981209076', TO_TIMESTAMP('2022-10-04 20:15:37', 'YYYY-MM-DD HH24:MI:SS'));
